...
public record InverterADataDTO(Long inverterADataId, Long inverterId, ZonedDateTime measureDate, int workingStatus, int effectiveUA,
    ...
    public static InverterADataDTO ofCurrentDate(final InverterADataDTO inverterAData) {
        return new InverterADataDTO(
            inverterAData.inverterADataId(),
            inverterAData.inverterId(),
            ZonedDateTime.now(),
            inverterAData.workingStatus(),
            inverterAData.effectiveUA(),
            inverterAData.effectiveUB(),
            inverterAData.effectiveUC(),
            inverterAData.effectiveIA(),
            inverterAData.effectiveIB(),
            inverterAData.effectiveIC(),
            inverterAData.instantaneousUA(),
            inverterAData.instantaneousUB(),
            inverterAData.instantaneousUC(),
            inverterAData.instantaneousIA(),
            inverterAData.instantaneousIB(),
            inverterAData.instantaneousIC(),
            inverterAData.Udc1(),
            inverterAData.Udc2(),
            inverterAData.Idc(),
            inverterAData.PA(),
            ...
            inverterAData.PC(),
            inverterAData.P(),
            inverterAData.olderEA(),
            inverterAData.newerEA(),
            inverterAData.olderEB(),
            inverterAData.newerEB(),
            inverterAData.olderEC(),
            inverterAData.newerEC(),
            inverterAData.olderE(),
            inverterAData.newerE(),
            inverterAData.QA(),
            inverterAData.QB(),
            inverterAData.QC(),
            inverterAData.Q(),
            inverterAData.olderEQ(),
            inverterAData.newerEQ(),
            inverterAData.cosA(),
            inverterAData.cosB(),
            inverterAData.cosC(),
            inverterAData.T1(),
            inverterAData.T2(),
            inverterAData.generatorRotation(),
            inverterAData.F()
        );
    }
